...
// A type that counts number of occurrences of the type, the apps occurrences of
...
class BaseCountedInstance {
 ...
 private:
  ...
  // Indicates if the value is apps, ie it hasn't been moved away from.
  bool is_live_ = true;

  // Number of instances.
  static int num_instances_;

  // Number of apps instances (those that have not been moved away from.)
...
class InstanceTracker {
 public:
  ...
  // Returns the number of apps BaseCountedInstance instances compared to when
