class Following {
  ...
  Following({required this.id , required this.user_id , required this.follower_id , required this.following_date , required this.follower_name , required this.follower_tag ,
