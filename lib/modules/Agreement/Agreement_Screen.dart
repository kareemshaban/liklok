...
3. Privacy
You acknowledge that you have read and fully understand our Privacy Policy, which describes how we handle the data you provide to us or generated when you use our Services. If you have any question, please contact us at:  support@chatScreen.apps
4. Virtual Items
...
You may terminate LikLok Services and this Agreement by revoking your LikLok account. You may contact us at: support@chatScreen.apps
6. Disclaimers
...
9. Contact us
9.1 Email: support@chatScreen.apps
9.2 WebSite: https://www.chatScreen.apps
...
3. الخصوصية
أنت تقر بأنك قرأت وفهمت سياسة الخصوصية الخاصة بنا بشكل كامل، والتي تصف كيفية تعاملنا مع البيانات التي تقدمها لنا أو التي يتم إنشاؤها عند استخدام خدماتنا. إذا كان لديك أي سؤال، يرجى الاتصال بنا على:  support@chatScreen.apps
...
5. إنهاء الخدمات
يجوز لك إنهاء LikLok Services وهذه الاتفاقية عن طريق إلغاء حساب LikLok الخاص بك. يمكنك الاتصال بنا على:  support@chatScreen.apps
6. إخلاء المسؤولية
...
9. اتصل بنا
9.1 البريد الإلكتروني:  support@chatScreen.apps
9.2 الموقع الإلكتروني: https://www.chatScreen.apps
9.3 التطبيق: LikLok  '''   )
                  ],
                )
