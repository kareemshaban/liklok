      ...
      appBar: PreferredSize(
        ...
        child: AppBar(
          ...
          actions: [
            ...
            }, icon:Icon( Icons.arrow_forward_ios , color: Colors.black , size: 25.0,))
          ],
        ),
      ),
      body: Container(
                          ...
                          child: Column(
                            children: [
                              Text(user!.followers!.length.toString() ,
                                style: TextStyle(color: MyColors.primaryColor , fontSize: 18.0 , fontWeight: FontWeight.bold),),
                              Text("followers_title".tr , style: TextStyle(color: Colors.black , fontSize: 15.0),)
                            ],
                          ),
                        ),
                      ),
                        ...
                        child: Column(
                          children: [
                            Text(user!.followings!.length.toString() ,
                              style: TextStyle(color: MyColors.primaryColor , fontSize: 18.0 , fontWeight: FontWeight.bold),),
                            Text("following_title".tr , style: TextStyle(color:Colors.black , fontSize: 15.0),)
                          ],
                        ),
                      ),
                    ),
                        ...
                        child: Column(
                          children: [
                            Text(user!.friends!.length.toString() ,
                              style: TextStyle(color: MyColors.primaryColor , fontSize: 18.0 , fontWeight: FontWeight.bold),),
                            Text("friends_title".tr , style: TextStyle(color: Colors.black , fontSize: 15.0),)
                          ],
                        ),
                      ),
                    ),
                        ...
                        child: Column(
                          children: [
                            Text(user!.visitors!.length.toString() ,
                              style: TextStyle(color: MyColors.primaryColor , fontSize: 18.0 , fontWeight: FontWeight.bold),),
                            Text("profile_visitors".tr , style: TextStyle(color: Colors.black , fontSize: 15.0),)
                          ],
                        ),
                      ),
                    ),
