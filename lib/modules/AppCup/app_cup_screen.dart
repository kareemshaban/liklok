    ...
    return  Scaffold(
      appBar: AppBar(
        ...
        title:  TabBar(
          ...
          tabs:  [
            Tab(child: Text("my_level_wealth".tr , style: TextStyle(fontSize: 14.0),), ),
            Tab(child: Text("my_level_karizma".tr , style: TextStyle(fontSize: 14.0),), ),
            Tab(child: Text("profile_room".tr , style: TextStyle(fontSize: 14.0),), ),
          ],
        ) ,
        actions: [
                        ...
                        children: [
                          ...
                          Container(
                            ...
                            child: TabBar(
                              ...
                              tabs:  [
                                Tab(child: Text("daily".tr , style: TextStyle(fontSize: 14.0),), ),
                                Tab(child: Text("weekly".tr , style: TextStyle(fontSize: 14.0),), ),
                                Tab(child: Text("monthly".tr , style: TextStyle(fontSize: 14.0),), ),
                              ],
                            ),
                          ),
                          Expanded(
